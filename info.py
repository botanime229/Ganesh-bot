...
# Bot information
SESSION = environ.get('SESSION', 'Anime_sender')
API_ID = int(environ.get('API_ID', '20902603'))
API_HASH = environ.get('API_HASH', '79e5caa103a9e9fb0183390b4800845d')
BOT_TOKEN = environ.get('BOT_TOKEN', "7831594380:AAF42YYiIDyU8GBoSmi6Rnde2F5rtJ8Q514")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://i.ibb.co/prb8wd3/image.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://i.ibb.co/XzvqKJy/image.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/85d361ab4cb6511006022.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://i.ibb.co/qNBwCCH/image.jpg")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002466214823').split()] #Channel id for auto indexing ( make sure bot is admin )
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002301110911') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002446321972') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002204789508') # request channel id ( make sure bot is admin )
